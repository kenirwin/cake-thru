...
class PortraitsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        '_indexes' => [
            'woman_portrait_key' => ['type' => 'index', 'columns' => ['woman_id'], 'length' => []],
        ],
        '_constraints' => [
            'primary' => ['type' => 'primary', 'columns' => ['id'], 'length' => []],
            'portrait_women_key' => ['type' => 'foreign', 'columns' => ['woman_id'], 'references' => ['women', 'id'], 'update' => 'restrict', 'delete' => 'restrict', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
